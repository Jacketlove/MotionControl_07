...
public enum ControlBoardTypeEnum {
	...
	S8440A("S8440A", 0,
			Constant.MAX_AXIS_NUM_S8440A, 
			Constant.MAX_IN_GPIO_NUM_S8440A, 
			Constant.MAX_OUT_GPIO_NUM_S8440A),
	
	B6612("B6612", 1,
			Constant.MAX_AXIS_NUM_B6612, 
			Constant.MAX_IN_GPIO_NUM_B6612, 
			Constant.MAX_OUT_GPIO_NUM_B6612),
	
	S8250("S8250", 2,
			Constant.MAX_AXIS_NUM_S8250, 
			Constant.MAX_IN_GPIO_NUM_S8250, 
			Constant.MAX_OUT_GPIO_NUM_S8250),
	
	B6308("B6308", 3,
			Constant.MAX_AXIS_NUM_B6308, 
			Constant.MAX_IN_GPIO_NUM_B6308, 
			Constant.MAX_OUT_GPIO_NUM_B6308),
	
	S8440B("S8440B", 4,
			Constant.MAX_AXIS_NUM_S8440B, 
			Constant.MAX_IN_GPIO_NUM_S8440B, 
			Constant.MAX_OUT_GPIO_NUM_S8440B,
			Constant.MAX_IN_EXPAND_NUM_S8440B,
			Constant.MAX_OUT_EXPAND_NUM_S8440B),
	
	B6428("B6428", 5,
			Constant.MAX_AXIS_NUM_B6428, 
			Constant.MAX_IN_GPIO_NUM_B6428, 
			Constant.MAX_OUT_GPIO_NUM_B6428),
	
	M9550("M9550", 6,
			Constant.MAX_AXIS_NUM_M9550, 
			Constant.MAX_IN_GPIO_NUM_M9550, 
			Constant.MAX_OUT_GPIO_NUM_M9550,
			Constant.MAX_IN_EXPAND_NUM_M9550,
			Constant.MAX_OUT_EXPAND_NUM_M9550),
	
	P2250("P2250", 7,
			Constant.MAX_AXIS_NUM_P2250, 
			Constant.MAX_IN_GPIO_NUM_P2250, 
			Constant.MAX_OUT_GPIO_NUM_P2250),
	
	C3850("C3850", 8,
			Constant.MAX_AXIS_NUM_C3850, 
			Constant.MAX_IN_GPIO_NUM_C3850, 
			Constant.MAX_OUT_GPIO_NUM_C3850);
